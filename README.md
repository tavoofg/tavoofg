...
### 🏛️ [Municipalidad de San Luis](#)
> Sitio web municipal desarrollado con **Next.js 16**, **React 19** y **TypeScript**. Incluye consulta de predios, servicios ciudadanos y diseño completamente responsivo.
`Next.js` `React` `TypeScript` `TailwindCSS`

---

### 🧠 [IndusWell — Salud Mental Ocupacional](#)
> Plataforma de evaluación de salud mental en el trabajo, construida con **PHP** y **PostgreSQL**. Incluye cuestionarios psicométricos, gestión de usuarios y reportes de bienestar laboral.
`PHP` `PostgreSQL` `JavaScript` `CSS3`
